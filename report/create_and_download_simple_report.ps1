...
$reportId = $report.id
$report | ConvertTo-Json -Depth 100 | Out-File "${scriptDir}\..\${reportId}_report_for_tenant_${tenantId}.json"
...
# Download the report
Invoke-WebRequest  -Uri "${baseUrl}api/2/reports/${reportId}/stored/${storedReportId}" -Headers $headers -OutFile "${scriptDir}\..\${storedReportId}_report.csv"